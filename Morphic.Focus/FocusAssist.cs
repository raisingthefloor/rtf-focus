...
namespace Morphic.Focus
{
    ...
    public class FocusAssist
    {
        ...
        private static UnsafeNative.WNF_STATE_NAME WNF_SHEL_QUIET_MOMENT_SHELL_MODE_CHANGED = new UnsafeNative.WNF_STATE_NAME() { data0 = 0xa3bf5075, data1 = 0xd83063e };
        private static UnsafeNative.WNF_STATE_NAME WNF_SHEL_QUIETHOURS_ACTIVE_PROFILE_CHANGED = new UnsafeNative.WNF_STATE_NAME() { data0 = 0xa3Bf1c75, data1 = 0xd83063e };
        ...
        private static MorphicResult<byte[], MorphicUnit> QueryWnfStateData(UnsafeNative.WNF_STATE_NAME stateName)
        {
            ...
            {
                uint changeStamp;
                var queryWnfStateDataResult = UnsafeNative.NtQueryWnfStateData(ref stateName, IntPtr.Zero, IntPtr.Zero, out changeStamp, pointerToBuffer, ref bufferSize);
        ...
        private static MorphicResult<MorphicUnit, MorphicUnit> UpdateWnfStateData(UnsafeNative.WNF_STATE_NAME stateName, byte[] buffer)
        {
            ...
            try
            {
                ...
                var updateWnfStateDataResult = UnsafeNative.NtUpdateWnfStateData(ref stateName, pointerToBuffer, (uint)bufferLength, IntPtr.Zero /* null */, IntPtr.Zero, 0, 0);
